...
package org.aoscp.software.interno;
...
import aoscp.app.CioContextConstants;
import aoscp.app.CustomTile;
import aoscp.app.CustomTileListenerService;
import aoscp.app.StatusBarPanelCustomTile;
import aoscp.app.ICustomTileListener;
import aoscp.app.ICioStatusBarManager;

import org.aoscp.interno.statusbar.ExternalQuickSettingsRecord;
import org.aoscp.interno.statusbar.IStatusBarCustomTileHolder;
 ...
 * @hide
 */
public class CioStatusBarManagerService extends SystemService {
    private static final String TAG = "CioStatusBarManagerService";
    ...
    public CioStatusBarManagerService(Context context) {
        super(context);
    }

    @Override
    public void onStart() {
        Log.d(TAG, "registerCioStatusBar ciostatusbar: " + this);
        mCustomTileListeners = new CustomTileListeners();
        publishBinderService(CioContextConstants.CIO_STATUS_BAR_SERVICE, mService);
    }

    private final IBinder mService = new ICioStatusBarManager.Stub() {
        /**
         * @hide
         */
        @Override
         ...
         * {@link aoscp.app.CustomTileListenerService}.
         * @hide
         */
        @Override
    ...
    private void enforceCustomTilePublish() {
        mContext.enforceCallingOrSelfPermission(
                aoscp.software.Manifest.permission.PUBLISH_CUSTOM_TILE,
                "StatusBarManagerService");
    }

    private void enforceBindCustomTileListener() {
        mContext.enforceCallingOrSelfPermission(
                aoscp.software.Manifest.permission.BIND_CUSTOM_TILE_LISTENER_SERVICE,
                "StatusBarManagerService");
    }
    ...
    public class CustomTileListeners extends ManagedServices {
        ...
        public CustomTileListeners() {
            super(CioStatusBarManagerService.this.mContext, mHandler, mQSTileList, mUserProfiles);
        }
