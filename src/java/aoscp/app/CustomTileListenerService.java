 ...
 * the aoscp.permission.BIND_CUSTOM_TILE_LISTENER_SERVICE
 * and include an intent filter with the {@link #SERVICE_INTERFACE} action. For example:</p>
 * <pre>
 * &lt;service android:name=".CustomTileListener"
 *          android:label="&#64;string/service_name"
 *          android:permission="aoscp.permission.BIND_CUSTOM_TILE_LISTENER_SERVICE">
 *     &lt;intent-filter>
 *         &lt;action android:name="aoscp.app.CustomTileListenerService" />
 *     &lt;/intent-filter>
 * &lt;/service></pre>
 */
public class CustomTileListenerService extends Service {
    ...
    public static final String SERVICE_INTERFACE
            = "aoscp.app.CustomTileListenerService";

    private ICustomTileListenerWrapper mWrapper = null;
    private ICioStatusBarManager mStatusBarService;
    ...
    private final ICioStatusBarManager getStatusBarInterface() {
        if (mStatusBarService == null) {
            mStatusBarService = ICioStatusBarManager.Stub.asInterface(
                    ServiceManager.getService(CioContextConstants.CIO_STATUS_BAR_SERVICE));
        }
    ...
    public void registerAsSystemService(Context context, ComponentName componentName,
        ...
        ICioStatusBarManager statusBarInterface = getStatusBarInterface();
     ...
     *
     * @param sbc A data structure encapsulating the original {@link aoscp.app.CustomTile}
     ...
     *            and source (package name) used to post the {@link aoscp.app.CustomTile} that
     *            was just removed.
     */
	...
	/**
     * Inform the {@link aoscp.app.CioStatusBarManager} about dismissal of a single custom tile.
     * <p>
