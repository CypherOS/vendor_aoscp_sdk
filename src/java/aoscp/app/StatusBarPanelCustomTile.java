 ...
 * the status bar panel and any {@link aoscp.app.CustomTileListenerService} clients.
 */
public class StatusBarPanelCustomTile implements Parcelable {
    ...
    /** The {@link aoscp.app.CustomTile} supplied to
     * {@link aoscp.app.CioStatusBarManager#publishTile(int, aoscp.app.CustomTile)}.
     */
    ...
    /** The id supplied to CioStatusBarManager */
    public int getId() {
        return id;
    }

    /** The tag supplied to CioStatusBarManager or null if no tag was specified. */
