 ...
 *
 * <p>The {@link aoscp.app.CustomTile.Builder} has been added to make it
...
public class CustomTile implements Parcelable {
    ...
    public CustomTile(Parcel parcel) {
        ...
        if (parcelableVersion >= Build.AOSCP_VERSION_API.CHEESECAKE) {
            if (parcel.readInt() != 0) {
     ...
     * You might want to consider using {@link aoscp.app.CustomTile.Builder} instead.
     */
    public CustomTile()
    {
        // Empty constructor
    ...
    /**
     * Builder class for {@link aoscp.app.CustomTile} objects.
     *
     * Provides a convenient way to set the various fields of a {@link aoscp.app.CustomTile}
     *
     * <p>Example:
     *
    ...
    public static class Builder {
         ...
         * @return {@link aoscp.app.CustomTile.Builder}
         */
        ...
        /**
         * Create a {@link aoscp.app.CustomTile} object
         * @return {@link aoscp.app.CustomTile}
         */
